...
import { CreateAnimation, IonButton, IonCol, IonDatetime, 
    IonIcon, IonRow, IonTitle } from '@ionic/react';
...
const WorkoutExp: React.FC<ContainerProps> = ({ sendStageToParent }) => {
  ...
  play={true}>
    <IonRow className="headerMargin">
        <IonCol>
        <IonTitle>חימום והכנות</IonTitle>
        </IonCol>
    </IonRow>
...
<IonCol>
    ...
    <IonRow>
        ...
        <IonButton color='light' fill='outline' onClick={() => {
           ...
           sendStageToParent("nogoal")
            }}>אחורה</IonButton>
        </IonCol>
        
        <IonCol className='center'>
        <IonButton color='light' fill='outline' onClick={() => {sendStageToParent("mainpart")}}>הבא</IonButton>
        </IonCol>
    </IonRow>
        </IonCol>
